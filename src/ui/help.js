...
export const HELP = [
  ...
  { sec: "place", tools: ["ahu", "hrv"], t: "I want to put the AHU or heat recovery unit down",
    b: "<b>AHU</b> <kbd>A</kbd> or <b>HRV</b> <kbd>E</kbd>, then click. Both are supply and extract in one box: supply leaves the right-hand side (SA), extract comes in on the left (EA). Turn it with the handle above the box." },
  ...
  { sec: "trace", tools: ["duct"], t: "I want to draw a duct",
    b: "<b>Trace</b> <kbd>T</kbd> asks <b>Supply</b> or <b>Extract</b>. Start on the ring of a unit, click each corner, and finish on the ring of a terminal — that click joins and drops the pencil. Double-click, <kbd>Enter</kbd> or <b>Finish</b> stops in mid-air." },
...
export const STEPS = [
  ...
  { t: "Trace the supply, then the extract", b: "<b>Trace</b>, choose Supply or Extract, start on the unit's ring, click the corners, finish on each terminal's ring. Branch off a duct by clicking the dot that appears on it. Change <b>Height</b> and click the same point for a riser." },
